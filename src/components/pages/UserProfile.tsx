  ...
  return (
    <AppShell title="My Profile">
      <div className="max-w-3xl mx-auto space-y-6">
        {/* Profile Header */}
        <div className="relative overflow-hidden rounded-2xl p-6 sm:p-8 text-white flex flex-col items-center gap-5 text-center" style={{ background: 'radial-gradient(circle at top, #142b14 0%, #050805 75%)' }}>
          ...
          <div className="relative z-10 w-20 h-20 rounded-2xl bg-white/20 backdrop-blur flex items-center justify-center text-3xl font-extrabold text-white border-2 border-white/30">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="block">
              ...
              <p className="mt-1.5 w-full rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-sm text-slate-900">
