          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 sm:p-10">
            ...
            <div className="space-y-3 w-full">
              {[
                ...
                { label: 'About Us', desc: 'Learn about our mission', href: '/about',
                  iconSvg: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg> },
              ].map((action, i) => (
                <button
                  key={i}
